...
<!-- Hero Start -->
<div class="container-fluid bg-primary py-5 px-md-5 mb-5">
    <div class="row align-items-center px-3">
        <div class="col-lg-6 text-center text-lg-left">
            ...
            <a href="<?= base_url('courses'); ?>" class="btn btn-secondary mt-1 p-3">Start Learning</a>
        </div>
            ...
            <div class="col-lg-7">
                <div class="text-center pb-2">
                    <p class="section-title px-5">
                        <span class="px-2">About Life Skills Training</span>
                    </p>
    ...
    <div class="container p-0">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="height: 200px; padding: 30px">
                    <div class="pl-4">
            ...
            <div class="col-lg-4 col-md-6" style="height: 150px;">
                <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="height: 200px; padding: 30px">
                    <i class="flaticon-047-backpack h1 font-weight-normal text-primary mb-3"></i>
                    <div class="pl-4">
            ...
            <div class="col-lg-4 col-md-6 pb-1" style="height: 150px;">
                <div class="d-flex bg-light shadow-sm border-top rounded mb-4" style="height: 200px; padding: 30px">
                    <i class="flaticon-047-backpack h1 font-weight-normal text-primary mb-3"></i>
                    <div class="pl-4">
    ...
    <div class="container p-0">
        ...
        <div class="owl-carousel testimonial-carousel">
            <div class="testimonial-item px-3">
                <div class="bg-light shadow-sm rounded mb-4 p-4" style="height: 150px;">
                    <h3 class="fas fa-quote-left text-dark mr-2" style="font-size:20px;"></h3>
